      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Uncovered Territories</CardTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card className="h-full">
            <CardHeader>
              <CardTitle>Uncovered Territories Insights</CardTitle>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 bg-blue-50 rounded">
                      ...
                      <div className="text-sm text-blue-700">High population density, strong growth potential</div>
                    </div>
                  </div>
                </div>
              </div>
